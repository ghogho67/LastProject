	...
	for (var i=0; i < listData2.length ; i++) {
		...
		naver.maps.Service.geocode({
		    ...
		    if (status !== naver.maps.Service.Status.OK) {
		        ...
		        var position = new naver.maps.LatLng(items[0].point.y,items[0].point.x);
		        ...
		        var infoWindow = new naver.maps.InfoWindow({
		            content: '<div style="width:150px;text-align:center;padding:10px;">The Letter is <b>"'+ "1234" +'"</b>.</div>'
		        });
