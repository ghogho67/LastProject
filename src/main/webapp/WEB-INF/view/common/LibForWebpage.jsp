...
<link rel="stylesheet" href="${cp}/resource/medino/css/style.css">

<link
	href="${cp}/resource/wrap/css/style.css"
	rel="stylesheet">
	...
	<script
		src="${cp}/resource/medino/js/vendor/bootstrap-4.1.3.min.js"></script>
	<script src="${cp}/resource/medino/js/vendor/wow.min.js"></script>
	<script
	...
	<script src="${cp}/resource/medino/js/vendor/superfish.min.js"></script>
	<script src="${cp}/resource/medino/js/main.js"></script>
