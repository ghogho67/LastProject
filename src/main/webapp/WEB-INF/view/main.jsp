...
function initSocket() {
   ...
   function onClose(evt){
	...
	<div class="slidebanner">
		<ul class="bannerbox">
			<li class="bannerli"><img
				src="/image/banner/BannerImg_201803140938370700.gif" alt="dw" /></li>
			<li class="bannerli"><img
				src="/image/banner/BannerImg_201709111200074660.gif" alt="dw" /></li>
			<li class="bannerli"><img
				src="/image/banner/BannerImg_201712121047180930.jpg" alt="dw" /></li>
			<li class="bannerli"><img
				src="/image/banner/BannerImg_201709111200074660.gif" alt="dw" /></li>
			<li class="bannerli"><img
				src="/image/banner/Banner_201803270948084380.jpg"></li>
			<li class="bannerli"><img
				src="/image/banner/Banner_201702071159070710.png" alt="dw" /></li>
			<li class="bannerli"><img
				src="/image/banner/Banner_201702071159070710.png" alt="dw" /></li>
			<li class="bannerli"><img
				src="/image/banner/Banner_201803270948084380.png" alt="dw" /></li>
			<li class="bannerli"><img
				src="/image/banner/BannerImg_201810220113360510.jpg"></li>
		</ul>
	</div>
			...
			<div style="width: 60%;">
				<div>
					<p>
						...
						282 2114 </br>PO Box 769558, twofour54, Abu Dhabi his bare hands by
						Michael Whitehead.</br> &copy Havoc Creative 2017
					</p>
				</div>
			</div>
		</div>
