			...
			<div class="pagination-div center">
				...
				<div class="pagination-div">
					...
					<ul class="pagination">
						...
						<li class="ng-scope"><a class="ng-binding active"> 1 </a></li>
						<li class="ng-scope"><a class="ng-binding"> 2 </a></li>
						<li class="ng-scope"><a class="ng-binding"> 3 </a></li>

						<li><a class="ng-scope"><span aria-hidden="true">&gt;</span></a></li>
						<li><a class="ng-scope"><span aria-hidden="true">&gt;&gt;</span></a></li>
