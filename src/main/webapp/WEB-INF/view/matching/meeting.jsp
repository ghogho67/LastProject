...
<script>
	...
	function popup() {
		window
				.open(
						"/chat/createChat?chatmem_id=${memVo.mem_id }&&chat_nm=${memVo.mem_id }님과 채팅",
					...
					<div class="container style="width: 1000px; height: 1000px;">
						...
						<div id="button" style="width: 40%; float: right; height: 400px;">
							...
							<br> <input type="button" class="M_btn" value="화상채팅"
								id="videochat"><br> <br> <input id="chatPlay"
								type="button" class="M_btn" value="채팅" onclick="popup()">
						</div>
					</div>
					<div class="container style="width: 1000px; height: 1000px;">
						<!-- 일자 클릭시 메뉴오픈 -->
						...
						<div id="wrapper">
							...
							${lo.loc_dong },							
										...
										<c:forEach items="${carList }" var="car" begin="1">
											<tr>
												<th>경력</th>
												<td>내용 : ${car.career_cont} 시작일 : ${car.career_st_dt }
													종료일 : ${car.career_end_dt } 소속 기관 : ${car.career_hos }</td>
											</tr>
										</c:forEach>
										...
										<div class="row" id="timeInfo">
											<div class="col-xs-12">
												<label class="col-xs-4" for="timeInfo">시간 선택</label> <label
													...
													type="checkbox" name="timeInfo[]" value="6">16:30~17:00
												</label>
											</div>
										</div>
										...
										<div class="row" id="dayInfo">
											<div class="col-xs-12">
												<label class="col-xs-4" for="dayInfo[]">요일 선택</label> <label
													...
													type="checkbox" name="dayInfo[]" value="2">월요일
												</label> <label class="checkbox-inline"> <input
													type="checkbox" name="dayInfo[]" value="3">화요일
												</label> <label class="checkbox-inline"> <input
													type="checkbox" name="dayInfo[]" value="4">수요일
												</label> <label class="checkbox-inline"> <input
													type="checkbox" name="dayInfo[]" value="5">목요일
												</label> <label class="checkbox-inline"> <input
													type="checkbox" name="dayInfo[]" value="6">금요일
												</label> <label class="checkbox-inline"> <input
													type="checkbox" name="dayInfo[]" value="7">토요일
												</label>
											</div>
										</div>
