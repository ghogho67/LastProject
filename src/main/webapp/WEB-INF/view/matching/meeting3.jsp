...
<div class="container-fluid" id="map"
	...
	<script	src="${pageContext.request.contextPath}/FullCalendar-Example-master/js/meeting.js"></script>
	<script	src="${pageContext.request.contextPath}/FullCalendar-Example-master/js/meetingAddEvent.js"></script>
