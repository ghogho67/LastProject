...
<body>
  <header style="margin-bottom: 20px;">
    <img class="logo" src="../logo.png" alt="RTCMultiConnection" /> <span class="logo-text">SACCO VIDEO REFERENCE</span>
  ...
  <footer style="text-align: center;">SACCO VIDEO REFERENCE | OH~DOA조</footer>
...
function openCanvasDesigner() {
    ...
    //location.href뺐음
    var href = '/webRTC_DEMO/RTCMultiConnection-master/demos/dashboard/canvas-designer.html?open=' + connection.isInitiator + '&sessionid=' + connection.sessionid + '&publicRoomIdentifier=' + connection.publicRoomIdentifier + '&userFullName=' + connection.extra.userFullName;
