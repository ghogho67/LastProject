...
<script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath }/se2/js/HuskyEZCreator.js"></script>
...
cate_id : ${cate_id }<br><br>
						...
						<form id="frm1" class="form-horizontal" role="form"	action="${cp}/post/register" method="post" enctype="multipart/form-data">
							...
							<form action="${pageContext.request.contextPath }/postRegister" method="post" id="frm">
							<textarea name="post_content" id="smarteditor" rows="10" cols="100" style="width:600px; height:412px;"></textarea> 
							</form>
