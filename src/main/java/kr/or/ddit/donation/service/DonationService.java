...
public class DonationService implements IDonationService {
	...
	*/
	...
	public List<DonationApprovalVo> getDonationList_Y() {
		return donationDao.getDonationList_Y();
	}
	...
	public List<DonationApprovalVo> getDonationList_N() {
		return donationDao.getDonationList_N();
	}
	...
	*/
	@Override
	public Map<String, Object> donationPagingList_Y(PageVo pageVo) {
		
		Map<String, Object> resultMap = new HashMap<String, Object>();
		resultMap.put("getDonationList_Y", donationDao.donationPagingList_Y(pageVo));
		
		int donationCnt_Y = donationDao.donationCnt_N();
		int paginationSize = (int) Math.ceil((double)donationCnt_Y/pageVo.getPageSize());
		resultMap.put("lastpaginationSize", paginationSize);
	...
	*/
	@Override
	public Map<String, Object> donationPagingList_N(PageVo pageVo) {
		Map<String, Object> resultMap = new HashMap<String, Object>();
		resultMap.put("getDonationList_N", donationDao.donationPagingList_N(pageVo));
		
		int donationCnt_N = donationDao.donationCnt_N();
		int paginationSize = (int) Math.ceil((double)donationCnt_N/pageVo.getPageSize());
		resultMap.put("lastpaginationSize", paginationSize);
