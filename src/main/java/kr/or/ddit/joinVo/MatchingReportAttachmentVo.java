...
public class MatchingReportAttachmentVo {
	...
	public MatchingReportAttachmentVo(String mem_id,String cw_mem_id, int rep_id) {
		super();
		this.mem_id = mem_id;
	...
	public MatchingReportAttachmentVo(int mat_id, String mat_title, String mat_cont, String mat_st, String mat_end,
			...
			String mat_del, int rep_id, Date rep_time, String rep_title, String rep_cont, int rep_att_id,
			String rep_att_path, String rep_att_nm) {
		super();
		this.mat_id = mat_id;
	...
	public String toString() {
		return "MatchingReportAttachmentVo [mat_id=" + mat_id + ", mat_title=" + mat_title + ", mat_cont=" + mat_cont
				...
				+ rep_title + ", rep_cont=" + rep_cont + ", rep_att_id=" + rep_att_id + ", rep_att_path=" + rep_att_path
				+ ", rep_att_nm=" + rep_att_nm + "]";
	}
