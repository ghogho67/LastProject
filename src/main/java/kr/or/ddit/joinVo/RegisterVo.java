...
public class RegisterVo {
	...
	public RegisterVo(String mem_id, String mem_nm, String mem_birth, String mem_gender, String mem_pass,
			...
			String pro_phone, String cw_driver, String cw_lic, int cw_day, int ser_type_id, int cw_ser_type_id,
			int mem_dis_id, int dis_id, int loc_id, String loc_dong, int cw_career_id, String career_cont,
	...
	public String toString() {
		return "RegisterVo [mem_id=" + mem_id + ", mem_nm=" + mem_nm + ", mem_birth=" + mem_birth + ", mem_gender="
				...
				+ ", cw_driver=" + cw_driver + ", cw_lic=" + cw_lic + ", cw_day=" + cw_day + ", ser_type_id="
				+ ser_type_id + ", cw_ser_type_id=" + cw_ser_type_id + ", mem_dis_id=" + mem_dis_id + ", dis_id="
				+ dis_id + ", loc_id=" + loc_id + ", loc_dong=" + loc_dong + ", cw_career_id=" + cw_career_id
				+ ", career_cont=" + career_cont + ", career_st_dt=" + career_st_dt + ", career_end_dt=" + career_end_dt
				+ ", career_hos=" + career_hos + ", hos_nm=" + hos_nm + ", hos_add=" + hos_add + ", hos_phone="
				+ hos_phone + "]";
	}
